...
public class create_insert_dulpicate_node {
    ...
    public static void insertDuplicateNodeL(BinaryTreeNode<Integer> root){
        if(root == null){
            return;
        }
        ...
        insertDuplicateNodeL(rootLeft);
        insertDuplicateNodeL(root.right);
    }
    public static void insertDuplicateNode(BinaryTreeNode<Integer> root) {
        ...
        if(root.left != null && root.left.left != null && root.left.data == root.left.left.data){
