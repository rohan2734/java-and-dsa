...
public class largest_node_than_x {
	...
	public static class QueueUsingLL<T> {
	   ...
	   public static class TreeNode<T> {
        ...
        public static int largestNodeThanX(TreeNode<Integer> root, int x){
            if(root == null){
                return x;
            }
            int count = 0;
            ...
            for(int i=0;i<root.children.size();i++){
                count += largestNodeThanX(root.children.get(i),x);
            }
        ...
        public static void main(String[] args) {
            ...
            int x=s.nextInt();
            System.out.println(largestNodeThanX(root,x));
        }
}
